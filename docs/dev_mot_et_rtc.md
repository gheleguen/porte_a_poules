# DEV -- Un moteur piloté à l'heure
## 1/ Introduction
La première étape du développement de cet outil est de chercher à piloter un moteur à courant continu de 1,5 à 3V au moyen d'une arduino UNO et d'une RTC pour donner l'heure. 
 - Dans cette configuration 1 bouton poussoir symbolise, les deux fins de courses. Le moteur devra s'arrêté lorsque ce bouton sera enclenché.
...
|Résistances 1Kohm ou autre valeur|||3|
|Bouton poussoir|||1|
...
## 3/ Réalisation
### 3.1 Hardware
Réaliser le circuit représenté ci dessous. [Le fichier fritzing est accessible ici](pictures/DevMR2-1.png)
...
## 5/ Améliorations
 - Ajouter un second bouton poussoir. (Un poussoir pour la descente et un autre pour la montée).
