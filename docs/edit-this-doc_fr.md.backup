...
|||
|-|-|
|Cette documentation est mise en page par ReadTheDocs.org et [lisible à l'adresse ci attaché](https://porte-a-poules.readthedocs.io/fr/latest/). En aucun cas, cette adresse permet d'éditer la documentation.|![ED1-1](pictures/appercu_read_the_doc.png)|
|Afin de pouvoir contribuer à cette documentation, vous pouvez contribuer directement au [repository GitHub](https://github.com/gheleguen/porte_a_poules).|![ED1-2](pictures/appercu_github.png)|
